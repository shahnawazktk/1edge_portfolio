...
<style>
  ...
  .sec-heading span.line {
    ...
    background: #fe4801; margin: 12px auto 0;
  }

  /* ===== MODULE CARDS ===== */
  .modules_section { padding: 75px 0; background: #f8f9fa; }
  .module-card {
    background: #fff;
    border-radius: 10px;
    padding: 35px 25px;
  ...
  .module-card .mod-icon svg { width: 32px; height: 32px; stroke: #fe4801; }
  .module-card h5 { font-weight: 700; color: #022f4a; margin-bottom: 10px; }
  .module-card p  { color: #666; font-size: .93rem; margin: 0; }

  /* ===== HOW IT WORKS ===== */
  .how_section { padding: 75px 0; }
  ...
  .step-box h5 { font-weight: 700; color: #022f4a; }
  .step-box p  { color: #666; font-size: .93rem; }

  /* ===== PRICING ===== */
  .pricing_section { padding: 75px 0; background: #f8f9fa; }
  .price-card {
    background: #fff;
    border-radius: 10px;
  ...
  .price-card.popular { border-color: #fe4801; }
  .price-card.popular .badge-popular {
    position: absolute; top: -14px; left: 50%; transform: translateX(-50%);
    background: #fe4801; color: #fff;
    padding: 4px 18px; border-radius: 20px; font-size: .78rem; font-weight: 700;
  }
  .price-card:hover { box-shadow: 0 10px 30px rgba(0,0,0,.1); transform: translateY(-5px); }
  .price-card h4 { font-weight: 700; color: #022f4a; margin-bottom: 5px; }
  .price-card .price-amount { font-size: 2.6rem; font-weight: 700; color: #fe4801; }
  .price-card .price-amount span { font-size: 1rem; color: #888; font-weight: 400; }
  .price-card ul { list-style: none; padding: 0; margin: 20px 0 30px; text-align: left; }
  .price-card ul li { padding: 7px 0; color: #555; font-size: .93rem; border-bottom: 1px solid #f0f0f0; }
  .price-card ul li::before { content: "✓ "; color: #fe4801; font-weight: 700; }
  .price-card .btn-plan {
    display: block; background: #022f4a; color: #fff;
    padding: 12px; border-radius: 5px; font-weight: 700;
    text-decoration: none; transition: background .3s;
  }
  .price-card.popular .btn-plan { background: #fe4801; }
  .price-card .btn-plan:hover { background: #fe4801; color: #fff; }
  .price-card.popular .btn-plan:hover { background: #d93d00; }
  ...
  .demo_section h2 { font-size: 2rem; font-weight: 700; margin-bottom: 15px; }
  .demo_section p  { font-size: 1.05rem; max-width: 560px; margin: 0 auto 30px; opacity: .92; }
  ...
  .demo_section .btn-outline-white {
    ...
    padding: 11px 36px; border-radius: 4px; font-weight: 700;
    text-decoration: none; margin: 0 8px 10px; transition: all .3s;
  }
  .demo_section .btn-white:hover { background: #022f4a; color: #fff; }
  .demo_section .btn-outline-white:hover { background: #fff; color: #fe4801; }

  /* ===== TESTIMONIALS ===== */
  .testimonial_section { padding: 75px 0; }
  .testi-card {
    background: #fff; border-radius: 10px;
    border: 1px solid #e8e8e8; padding: 30px 25px;
    margin-bottom: 30px;
  }
  .testi-card p { color: #555; font-style: italic; margin-bottom: 20px; }
  .testi-card .testi-author { display: flex; align-items: center; gap: 12px; }
  .testi-card .testi-author img { width: 48px; height: 48px; border-radius: 50%; object-fit: cover; }
    ...
    <div class="row">
      ...
      <div class="col-md-3">
        <div class="step-box">
          ...
          <p>We configure the platform with your school's data — classes, teachers, and students — in 48 hours.</p>
        </div>
      </div>
      <div class="col-md-3">
        <div class="step-box">
          ...
          <p>Our trainers conduct live sessions so your staff can use every module with confidence from day one.</p>
        </div>
      </div>
      <div class="col-md-3">
        <div class="step-box">
          ...
          <h5>Go Live &amp; Grow</h5>
          <p>Launch the platform school-wide and enjoy ongoing support, updates, and new features every month.</p>
        </div>
      </div>
    </div>
  </div>
